...
//#include "lv_examples/src/benchmark/benchmark.h"
...
//#include "lv_my_gui/lv_gui_create.h"
//#include "lv_my_gui/gui_SecLayer_Expense.h"
...
int main(int argc, char** argv)
{
	...
	//beginning of sigmastar roommachine ui
	gui_sys_init();
